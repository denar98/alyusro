                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php if ($row_ujroh->jenis_ujroh == "Ujroh" && $row_ujroh->status == "0") { ?><button class="btn btn-info"><a href="<?= base_url() ?>Laskar/bayarUjrohAction/<?= $row_ujroh->id_ujroh ?>/<?= $row_ujroh->user_id_laskar ?>/<?= $row_ujroh->nominal_ujroh ?>" class="text-white">Bayar Ujroh</a></button><?php } ?></td>
