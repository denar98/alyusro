      ...
      <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link menu-link" href="tables-datatables.html#sidebarAdministrasi" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
            <i class=" ri-survey-line"></i> <span data-key="t-authentication">Administrasi</span>
          </a>
          <div class="collapse menu-dropdown" id="sidebarAdministrasi">
            <ul class="nav nav-sm flex-column">
              <li class="nav-item">
                <a href="<?= base_url() ?>UmrahTerjadwal/Daftar" class="nav-link" role="button" aria-expanded="false"> Surat Pernyataan Keberangkatan
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url() ?>TabunganUmrah/Daftar" class="nav-link " role="button" aria-expanded="false"> Tabungan Umrah
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url() ?>Donasi/Daftar" class="nav-link" role="button" aria-expanded="false"> Donasi
                </a>
              </li>
            </ul>
          </div>
        ...
        <li class="nav-item">
          ...
          <div class="collapse menu-dropdown" id="sidebarListing">
            <ul class="nav nav-sm flex-column">
              <li class="nav-item">
                <a href="<?= base_url() ?>UmrahTerjadwal/Listing" class="nav-link " role="button" aria-expanded="false"> Umrah Terjadwal
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url() ?>TabunganUmrah/Listing" class="nav-link" role="button" aria-expanded="false"> Tabungan Umrah
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url() ?>Agen/Listing" class="nav-link" role="button" aria-expanded="false"> Perwakilan
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url() ?>Laskar/Listing" class="nav-link" role="button" aria-expanded="false"> Agen
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url() ?>UmrahTerjadwal/ListingJemaah" class="nav-link" role="button" aria-expanded="false"> Database Jemaah
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url() ?>Donasi/Listing" class="nav-link" role="button" aria-expanded="false"> Donasi
                </a>
              </li>
            </ul>
          </div>
        ...
        <li class="nav-item">
          ...
          <div class="collapse menu-dropdown" id="sidebarKeuangan">
            <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item">
                <a href="<?= base_url() ?>Validasi/HistoryPembayaran" class="nav-link" data-key="t-history-pembayaran"> History Pembayaran
                </a>
              </li>
              <li class="nav-item">
